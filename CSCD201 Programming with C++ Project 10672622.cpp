...
{
 cout<<"=================================================\n";
 cout<<"Index No. : "<<rollno<<"\tName  : "<<name<<"\n";
 cout<<"Course    : "<<Class <<"\tMarks : "<<marks<<"\tGrade : "<<grade<<"\n";
// cout<<"=================================================\n";
}
...
void search()
{
 ...
 if(found=='n') cout<<"\nThe Index No. "<<rno<<" is not in the file...\n";
 fin.close();
}
...
void Classwise()
{
 ...
 if(found=='n') cout<<"\nThe Course "<<std<<" is not in the file...\n";
 fin.close();
}
...
void Modify()
{
 ...
 char found='n';
 fio.seekg(0);
 cout<<"\nEnter the Index No. whose record is to be modified: ";
 cin>>rno;
...
//   fio.read((char*)&s,sizeof(s));
  ...
  cout<<"\nYour record of the Index No. "<<rno
      <<" has been updated....";
   }
 }
 if(found=='n') cout<<"\nThe Course "<<rno<<" is not in the file...\n";
 fio.close();
}
...
void Delete()
{
 ...
 cout<<"\nEnter the Index No. whose record is to be deleted: ";
 cin>>rno;
